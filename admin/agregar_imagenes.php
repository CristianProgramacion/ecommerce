...
<div class="container" style="margin-top: 1%;">
	<div class="card text-white bg-secondary">
		<div class="card-header">Agregar imagenes</div>
			<div class="card-body">
				...
				<form action="ins_imagenes.php" method="POST" enctype="multipart/form-data">
					...
					<input type="submit" name="Guardar" class="btn btn-info">
				</form>
			</div>
		</div>
		...
		<?php 
		 ...
		 <div class="row">
		 	<?php 
		 		//consulta que trae las iamgenes
		 	 ...
		 	 <div class="col-4">
		 	 	<div class="card" style="width: 20rem; margin-top: 1%;">
		 	 		...
		 	 		<a href="#" onclick="bootbox.confirm('Deseas realizar esta acción', function(result){
		 	 			if (result == true){ 
