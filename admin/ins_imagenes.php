...
if ($_SERVER['REQUEST_METHOD']=='POST'){
	//traer imagenes de forma multiple
	//necesitar una clave
...
//redimensionar
	...
	//si toda funciona bien
			if ($ins){
			echo alerta ('Imagenes guardadas correctamente','agregar_imagenes.php?clave='.$clave_producto.'');
			}else{
			echo alerta ('Imagenes  no guardadas','agregar_imagenes.php?clave='.$clave_producto.'');				
			}
			$ins = null;
			$con = null;
}else{
	echo alerta('utilizar formulario','agregar_imagenes.php?clave='.$clave_producto.'');
}
